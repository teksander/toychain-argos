...
class Navigate(object):
    ...
    def saturate(self, left, right, style = 1):
        ...
        if style == 2:
            ...
            if left > self.MAX_SPEED_LEFT:
                left = self.MAX_SPEED_lEFT
            elif left < -self.MAX_SPEED_LEFT:
                left = -self.MAX_SPEED_LEFT

            if right > self.MAX_SPEED_RIGHT:
                right = self.MAX_SPEED_RIGHT
            elif right < -self.MAX_SPEED_RIGHT:
                right = -self.MAX_SPEED_RIGHT                
...
class RandomWalk(object):
    ...
    def __init__(self, robot, MAX_SPEED):
        ...
        # Simulate broken motors
        self.MAX_SPEED_LEFT = MAX_SPEED
        self.MAX_SPEED_RIGHT = MAX_SPEED
    ...
    def step(self):
        ...
        if self.__walk:
            ...
            # Saturate wheel actuators (style = 2 simulates broken motors)
            left, right = self.saturate(left, right, style = 2)
